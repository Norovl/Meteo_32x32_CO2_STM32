...
1.  (показания на улице (Out)) Температура + Влажность + График(и)/давление, (показания в квартире (In)) Температура + Влажность + График(и)/СО2. (отрицательные значения температуры отображаются синим цветом); \[0\]
...
4.  Абсолютная влажность (г/м3) на улице и в квартире + часовой график; \[3\]
...
9.  Абсолютная влажность (г/м3) за час (на начало и конец часа) на улице и в квартире; \[12\]
...
14.  Суточный график абсолютной влажности (г/м3) на улице и в квартире с последовательным отображением показаний за каждый час суток; \[22\]
